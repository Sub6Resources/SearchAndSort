...
namespace SearchAndSort
{
    public class StaticTank : EnemyTank
    {
        ...
        public StaticTank() { }
        public StaticTank(Game1 _game, string _tankSpriteName, Vector2 _location, Vector2 _speed, float _rotation, int _player, float _scale, Texture2D _whiteRectangle)
        {
